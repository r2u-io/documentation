...
function parseMarkdownString(markdownFileContent, options) {
    var _a;
    try {
        const sourceOption = options === null || options === void 0 ? void 0 : options.source;
        ...
        if (frontMatter.title &&
            ...
            console.warn(chalk_1.default.yellow(`Duplicate title found in ${sourceOption !== null && sourceOption !== void 0 ? sourceOption : 'this'} file.
